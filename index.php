...
<body>
   ...
   <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.min.js"></script>
    ...
    <!-- 1 Copy to clipboard and create Excel, PDF and CSV files from the table's data. -->
    ...
    <!-- 3. colvis End user buttons to control column visibility.-->
